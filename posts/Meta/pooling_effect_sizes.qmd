...
4.  如果您希望其他人可以在 *R* 之外尽可能精确地复制您的结果，那么 DerSimonian-Laird 估计器是首选方法。
...
3.  池化效果大小。我们看到估计值g≈0.58，并且 95% 置信区间范围为0.38 至 0.78。 Knapp-Hartung 调整 t分布，

4.  研究间异质性：$\tau$ 明显大于零。所有这些都表明我们的数据中存在研究间异质性，随机效应模型是一个不错的选择。
